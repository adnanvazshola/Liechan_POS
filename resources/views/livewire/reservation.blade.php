                    ...
                    <div class="sticky-top mb-3">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Buat Pilihan Baru</h3>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="external-events">
                                    <div class="external-event bg-danger">Reservasi Tempat</div>
                                    <div class="external-event bg-success">Pesan Makanan</div>
                                    <div class="external-event bg-primary">Lainnya</div>
                                    <div class="checkbox">
...
@push('js')
    ...
    <script src="{{ asset('adminLTEplugins/raphael/raphael.min.js') }}"></script>
    <script src="{{ asset('adminLTE/plugins/jquery-mapael/jquery.mapael.min.js') }}"></script>
    <script src="{{ asset('adminLTEplugins/jquery-mapael/maps/usa_states.min.js') }}"></script>
    <script src="{{ asset('adminLTEplugins/chart.js/Chart.min.js') }}"></script>
    <script src="{{ asset('adminLTEdist/js/pages/dashboard2.js') }}"></script> --}}
    <!-- Khusus -->
